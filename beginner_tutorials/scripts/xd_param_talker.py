...
def param_talker():
    ...
    param_name = rospy.search_param('utterance')
    rospy.loginfo('found utterance parameter under key: %s'%param_name)
    param_name = rospy.search_param('P')
    rospy.loginfo('found P parameter under key: %s'%param_name)
    param_name = rospy.search_param('topic_name')
    rospy.loginfo('found topic_name parameter under key: %s'%param_name)
